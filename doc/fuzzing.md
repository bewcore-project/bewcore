...
with certain assembly code from BewCore's code. See [developer notes on sanitizers](https://github.com/bewcore-project/bewcore/blob/master/doc/developer-notes.md#sanitizers)
